...
| Analytics | Statistical analysis, predictive modeling, A/B testing, cohort analysis, forecasting, segmentation |
| BI and visualization | Amazon QuickSight, Power BI, Tableau, Plotly, Matplotlib, Seaborn, executive dashboards |
| Data engineering | ETL, data cleaning, API integration, database management, data warehousing concepts |
| Advertising platforms | Google Ad Manager, DV360, The Trade Desk, GA4, Google Tag Manager, Google Ads, Meta Ads, LinkedIn Campaign Manager |
| Business analysis | Requirements gathering, stakeholder management, UAT, gap analysis, business cases, ROI analysis, Agile/Scrum |
...
I am focused on roles where analytics directly supports business decisions: Business Analyst, Data Analyst, Marketing Analyst, BI Analyst, Programmatic Advertising Analyst, and Ad-Tech Analytics roles.

The work I enjoy most has a clear business surface area: a trusted dashboard, a model tied to a decision, a campaign measurement readout, or a recommendation that improves the next action.

---

<div align="center">

**Open to analytics, BI, marketing analytics, and programmatic advertising analytics opportunities.**

[Connect on LinkedIn](https://www.linkedin.com/in/shahbazshaikh-) | [Email Me](mailto:shaks.shahbaz@gmail.com)
